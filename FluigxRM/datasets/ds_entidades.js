...
function createDataset(fields, constraints, sortFields) {
    ...
    //var retorno = authService.readView("RhuEntidadesData", parsedConstraints.filter, parsedConstraints.context, senha, filtro);  
      
      
    var xmlResultados = new XML(retorno);  
  
    var dataset = DatasetBuilder.newDataset();     
             dataset.addColumn('CODENTIDADE');   
             dataset.addColumn('RAZAOSOCIAL');   
             dataset.addColumn('NOMEFANTASIA');   
    for(var i = 0; i < xmlResultados.VEntidades.length(); i++)   
    {   
