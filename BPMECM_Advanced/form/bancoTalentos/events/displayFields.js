function displayFields(form,customHTML){
	...
	var usuario = getValue("WKUser");
	 ...
	 "<h3>Ficou curioso, né? Então, aqui está o LinkedIn: <b>" +linkedin+ "</b>. Mas não esqueça de entrar em contato depois, hein?<br>" +
	 "Para te ajudar, aqui segue o email: <b>" +email+"</b> e o celular para contato<b> " +celular+"</b>.<br>"  +
